...
class Adam(Optimizer):
    ...
    Arguments:
        ...
        amsgrad (boolean, optional): whether to use the AMSGrad variant of this
            GC_optims from the paper `On the Convergence of Adam and Beyond`_
            (default: False)
...
class AdamW(Optimizer):
    r"""Implements AdamW GC_optims.

    The original Adam GC_optims was proposed in `Adam: A Method for Stochastic Optimization`_.
