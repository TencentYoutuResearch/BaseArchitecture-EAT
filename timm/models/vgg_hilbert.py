...
model_cfgs = dict(
    vgg16_hil=_mcfg(cfg=cfgs['vgg16'], hilbert_space=False, kernel_size=(3, 3), padding=(1, 1)),
    vgg16_bn_hil=_mcfg(cfg=cfgs['vgg16'], hilbert_space=False, kernel_size=(3, 3), padding=(1, 1)),
    vgg16_bn_3x1_hil=_mcfg(cfg=cfgs['vgg16'], hilbert_space=False, kernel_size=(3, 1), padding=(1, 0)),

    vgg19_hil=_mcfg(cfg=cfgs['vgg19'], hilbert_space=False, kernel_size=(3, 3), padding=(1, 1)),
    vgg19_bn_hil=_mcfg(cfg=cfgs['vgg19'], hilbert_space=False, kernel_size=(3, 3), padding=(1, 1)),
    vgg19_bn_3x1_hil=_mcfg(cfg=cfgs['vgg19'], hilbert_space=False, kernel_size=(3, 1), padding=(1, 0)),
)
...
default_cfgs = {
    'vgg16_hil': _cfg(url=''),
    'vgg16_bn_hil': _cfg(url=''),
    'vgg16_bn_3x1_hil': _cfg(url=''),

    'vgg19_hil': _cfg(url=''),
    'vgg19_bn_hil': _cfg(url=''),
    'vgg19_bn_3x1_hil': _cfg(url=''),
}
    ...
    def __init__(
        ...
        for v in cfg['cfg']:
            ...
            if v == 'M':
                ...
                v = cast(int, v)
                conv2d = conv_layer(prev_chs, v, kernel_size=cfg['kernel_size'], padding=cfg['padding'])
...
@register_model
def vgg16_hil(pretrained: bool = False, **kwargs: Any) -> VGG:
    r"""VGG 16-layer model (configuration "D")
    `"Very Deep Convolutional Networks For Large-Scale Image Recognition" <https://arxiv.org/pdf/1409.1556.pdf>`._
    """
    model_args = dict(**kwargs)
    return _create_vgg('vgg16_hil', pretrained=pretrained, **model_args)


@register_model
def vgg16_bn_hil(pretrained: bool = False, **kwargs: Any) -> VGG:
    r"""VGG 16-layer model (configuration "D") with batch normalization
    `"Very Deep Convolutional Networks For Large-Scale Image Recognition" <https://arxiv.org/pdf/1409.1556.pdf>`._
    """
    model_args = dict(norm_layer=nn.BatchNorm2d, **kwargs)
    return _create_vgg('vgg16_bn_hil', pretrained=pretrained, **model_args)


@register_model
def vgg16_bn_3x1_hil(pretrained: bool = False, **kwargs: Any) -> VGG:
    r"""VGG 16-layer model (configuration "D") with batch normalization
    `"Very Deep Convolutional Networks For Large-Scale Image Recognition" <https://arxiv.org/pdf/1409.1556.pdf>`._
    """
    model_args = dict(norm_layer=nn.BatchNorm2d, **kwargs)
    return _create_vgg('vgg16_bn_3x1_hil', pretrained=pretrained, **model_args)


@register_model
def vgg19_hil(pretrained: bool = False, **kwargs: Any) -> VGG:
    r"""VGG 19-layer model (configuration "E")
    `"Very Deep Convolutional Networks For Large-Scale Image Recognition" <https://arxiv.org/pdf/1409.1556.pdf>`._
    """
    model_args = dict(**kwargs)
    return _create_vgg('vgg19_hil', pretrained=pretrained, **model_args)


@register_model
def vgg19_bn_hil(pretrained: bool = False, **kwargs: Any) -> VGG:
    r"""VGG 19-layer model (configuration 'E') with batch normalization
    `"Very Deep Convolutional Networks For Large-Scale Image Recognition" <https://arxiv.org/pdf/1409.1556.pdf>`._
    """
    model_args = dict(norm_layer=nn.BatchNorm2d, **kwargs)
    return _create_vgg('vgg19_bn_hil', pretrained=pretrained, **model_args)


@register_model
def vgg19_bn_3x1_hil(pretrained: bool = False, **kwargs: Any) -> VGG:
    r"""VGG 19-layer model (configuration 'E') with batch normalization
    `"Very Deep Convolutional Networks For Large-Scale Image Recognition" <https://arxiv.org/pdf/1409.1556.pdf>`._
    """
    model_args = dict(norm_layer=nn.BatchNorm2d, **kwargs)
    return _create_vgg('vgg19_bn_3x1_hil', pretrained=pretrained, **model_args)
